...
EFI_STATUS InsertPointerRecordList(IN POINTER_LIST *PointerList,
                             ...
                             IN CONST UINT64 Site,
                             IN CONST UINTN Size, IN CONST BOOLEAN Syncable);

VOID FreePointerRecordList(IN POINTER_LIST *PointerList, IN POINTER_SYNC_TYPE SyncType);
VOID SyncPointerRecordList(IN POINTER_LIST *PointerList, IN POINTER_SYNC_TYPE SyncType);
